...
L["enableCooldownManagerSlashCommandDesc"] = "Registers /cdm (and /wa if WeakAuras is not loaded) to open the Cooldown Viewer settings. Skips if another add-on already claims the command."
