...
-- TODO remove when midnight releases
...
local allowedSpells = { -- Tinker Engineering
	...
	[431424] = { duration = 300, isInvis = true }, -- Draught of Silent Footfalls
...
function addon.MythicPlus.functions.InitCooldownTracker()
	if addon.MythicPlus.variables.cooldownTrackerInitialized then return end
	if not addon.db then return end
	addon.MythicPlus.variables.cooldownTrackerInitialized = true
